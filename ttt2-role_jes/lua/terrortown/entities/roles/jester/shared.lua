...
function ROLE:PreInitialize()
	...
	self.abbr = "jes"
	self.visibleForTeam = {TEAM_TRAITOR, TEAM_DOPPELGANGER}
	self.score.surviveBonusMultiplier = 0.3
...
if SERVER then
	...
	local function SetUpWinstate()
		...
		if JESTER.winstate == 7 then
			JESTER.visibleForTeam = {TEAM_TRAITOR, TEAM_SERIALKILLER, TEAM_DOPPELGANGER}
		else
			JESTER.visibleForTeam = {TEAM_TRAITOR, TEAM_DOPPELGANGER}
		end
	end
