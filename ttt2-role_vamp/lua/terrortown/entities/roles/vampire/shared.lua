...
roles.InitCustomTeam(ROLE.name, {
		icon = "vgui/ttt/dynamic/roles/icon_vamp",
...
if CLIENT then
	...
	bind.Register("vamptranstoggle", ToggleTransformation, nil, "Vampire", "Toggle Transformation", KEY_B)
end
